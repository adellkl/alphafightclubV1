...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white text-black border-t border-gray-100 pt-16 pb-8">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-6">
            <NavLink to="/" className="text-3xl font-display font-bold italic uppercase">
          ...
          <div className="flex flex-col items-start md:items-end gap-4">
             <h4 className="text-gray-400 font-bold uppercase text-xs tracking-widest border-b border-gray-100 pb-2 mb-1 w-full md:w-auto text-left md:text-right">Nos Partenaires</h4>
             <div className="flex flex-wrap justify-start md:justify-end items-center gap-3">
                {PARTNERS.map((partner, idx) => (
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer"
                    className="group bg-white border border-gray-200 p-2 rounded-sm hover:border-brand-red transition-all w-20 h-12 flex items-center justify-center"
                    title={partner.name}
                  >
                    <img 
                      src={partner.logo} 
        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-400 gap-4">
           <p>&copy; {new Date().getFullYear()} Alpha Fight Club. Association Loi 1901.</p>
