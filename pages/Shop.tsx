    ...
    <main className="pt-32">
      ...
      <Section gray className="pt-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {PRODUCTS.map((product, idx) => (
                ...
                >
                    ...
                    {/* Product Info */}
                    <div className="p-6">
                        <h3 className="font-display font-bold text-black text-2xl uppercase mb-3 group-hover:text-brand-red transition-colors">
                          {product.name}
                        </h3>
                        ...
                        <div className="flex justify-between items-center mt-6 pt-4 border-t-2 border-gray-100">
                            ...
                            <button className="bg-black text-white px-6 py-3 text-xs font-bold uppercase tracking-widest hover:bg-brand-red transition-all duration-300 rounded-sm flex items-center gap-2 shadow-md hover:shadow-lg">
                                <ShoppingBag size={16} />
                                Commander
                            </button>
                        </div>
        ...
        <div className="mt-16 max-w-3xl mx-auto">
          <div className="bg-white border-l-4 border-brand-red p-6 shadow-md rounded-sm">
            <div className="flex items-start gap-4">
              <ShoppingBag className="text-brand-red shrink-0 mt-1" size={24} />
              <div>
                <h4 className="font-display font-bold text-lg uppercase mb-2">Comment commander ?</h4>
