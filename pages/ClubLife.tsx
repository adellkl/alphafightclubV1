      ...
      <Section className="pt-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
            <div className="order-2 md:order-1 px-6 md:px-0">
                <h3 className="text-4xl font-display font-bold text-black uppercase mb-6">Stages Techniques</h3>
                ...
                <div className="inline-block bg-black text-white px-6 py-3 font-bold uppercase tracking-widest hover:bg-brand-red transition-colors rounded-sm">
                    Prochain stage : Juin 2024
                </div>
            </div>
            <div className="order-1 md:order-2">
                <div className="relative p-4 border-2 border-black rounded-sm">
                     ...
                     <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-brand-red z-[-1]"></div>
                </div>
            </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
                 <div className="relative p-4 border-2 border-black rounded-sm">
                    ...
                    <div className="absolute -top-4 -right-4 w-24 h-24 bg-gray-200 z-[-1]"></div>
                 </div>
            </div>
            <div className="px-6 md:px-0">
                <h3 className="text-4xl font-display font-bold text-black uppercase mb-6">Événements Sociaux</h3>
