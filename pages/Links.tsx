      ...
      <Section gray className="pt-6 md:pt-10">
        <div className="max-w-3xl mx-auto space-y-3 sm:space-y-4 px-4 sm:px-0">
            {[
                ...
                <a key={idx} href="#" className="block bg-white p-5 sm:p-6 md:p-8 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all flex justify-between items-center group border-l-4 border-transparent hover:border-brand-red rounded-sm gap-4">
                    <span className="font-bold text-sm sm:text-base md:text-lg text-gray-800 group-hover:text-black uppercase break-words flex-1">{link}</span>
