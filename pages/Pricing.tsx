      ...
      <Section gray className="pt-6 md:pt-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 max-w-6xl mx-auto">
                ...
                <div className="flex gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-gray-300 space-y-1 mt-1 text-sm sm:text-base">
                      <li className="text-blue-400"><strong className="text-blue-300">Lundi Enfants :</strong></li>
                      <li className="pl-3 text-sm">• 17h-18h : 6-9 ans</li>
                      <li className="pl-3 text-sm">• 18h-19h : 10-14 ans</li>
                      <li className="mt-2"><strong className="text-white">Mercredi & Vendredi :</strong> 20h00 - 22h00</li>
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            {/* Section Tarifs Adultes */}
            <div className="mb-2">
              <h3 className="text-lg sm:text-xl font-display font-bold uppercase text-black flex items-center gap-2">
            ...
            <div className="mt-6 mb-2">
              <h3 className="text-lg sm:text-xl font-display font-bold uppercase text-black flex items-center gap-2">
                ...
                Tarifs Enfants
                <span className="ml-2 bg-blue-600 text-white text-[10px] font-bold px-2 py-0.5 rounded uppercase">Nouveau</span>
              </h3>
            </div>

            <div className="bg-white p-5 sm:p-6 md:p-8 border-2 border-blue-200 hover:border-blue-400 shadow-sm hover:shadow-xl transition-all relative rounded-sm group">
              <div className="absolute top-0 right-0 bg-blue-600 text-white text-[10px] sm:text-xs font-bold px-2 sm:px-3 py-1 uppercase">6-14 ans</div>

              <h3 className="text-xl sm:text-2xl font-display font-bold uppercase mb-2 text-black">Adhésion Enfant</h3>
              <div className="text-3xl sm:text-4xl font-bold text-blue-600 mb-4 sm:mb-6">180,00 € <span className="text-xs sm:text-sm text-gray-400 font-normal">/ saison</span></div>

              <ul className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
                <li className="flex items-start gap-2 sm:gap-3 text-gray-600 text-sm sm:text-base">
                  <Check size={18} className="sm:w-5 sm:h-5 text-blue-600 shrink-0 mt-0.5" />
                  <span>Cours tous les lundis</span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3 text-gray-600 text-sm sm:text-base">
                  <Check size={18} className="sm:w-5 sm:h-5 text-blue-600 shrink-0 mt-0.5" />
                  <span>17h-18h : 6-9 ans</span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3 text-gray-600 text-sm sm:text-base">
                  <Check size={18} className="sm:w-5 sm:h-5 text-blue-600 shrink-0 mt-0.5" />
                  <span>18h-19h : 10-14 ans</span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3 text-gray-600 text-sm sm:text-base">
                  <Check size={18} className="sm:w-5 sm:h-5 text-blue-600 shrink-0 mt-0.5" />
                  <span>Licence FFLDA incluse</span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3 text-gray-600 text-sm sm:text-base">
                  <Check size={18} className="sm:w-5 sm:h-5 text-blue-600 shrink-0 mt-0.5" />
                  <span>Assurance sportive incluse</span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3 text-gray-600 text-sm sm:text-base">
                  <Check size={18} className="sm:w-5 sm:h-5 text-blue-600 shrink-0 mt-0.5" />
                  <span>Encadrement par Mathis & Anis</span>
                </li>
              </ul>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block w-full text-center bg-blue-600 text-white py-3 sm:py-4 font-display font-bold uppercase tracking-widest hover:bg-black transition-colors text-sm sm:text-base md:text-lg group-hover:shadow-lg"
              >
                Inscrire mon enfant
              </a>
            </div>
